...
public class Report {
	...
	public static Report getInstance(){
		if(report==null){
			...
			testSummary.config().setDocumentTitle("My Account - Report generated by Test Automation");
			testSummary.config().setReportName("My Account - Report generated by Test Automation");
