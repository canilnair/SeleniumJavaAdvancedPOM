...
public class Settings {
	...
	public void setScreenshotsDir() {
		this.screenshotsDir = getProjectPath()+System.getProperty("file.separator")+"resources"+System.getProperty("file.separator")+"screenshots"+System.getProperty("file.separator");
	}
	/**
	 * 
